...
$(function () {
  ...
  QUnit.test('should provide no conflict', function (assert) {
    assert.expect(1);
    assert.strictEqual(_typeof($.fn.scrollspy), 'undefined', 'scrollspy was set back to undefined (org value)');
  });
  ...
  QUnit.test('should add the active class to the correct element', function (assert) {
    ...
    var testElementIsActiveAfterScroll = function testElementIsActiveAfterScroll(element, target) {
      var deferred = $.Deferred(); // add top padding to fix Chrome on Android failures
  ...
  QUnit.test('should allow passed in option offset method: offset', function (assert) {
    ...
    var testOffsetMethod = function testOffsetMethod(type) {
